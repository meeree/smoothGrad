...
def analyze_network_discrete(folder = '', train = False, specific_epoch = -1):
    ...
    if train:
        ...
        net = fit(net, f'song_all_lr{lr}_std{std}_S{S}', toy_params, net_params, train_params, trainData, validData, trainOutputMask, validOutputMask, override_data=True) 
...
analyze_network_discrete('song_all_lr0.005_std0.1_S100', False)
